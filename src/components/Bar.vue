    ...
    <div
        ...
        <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
            ...
            <div class="flex items-center justify-center">
                <button data-tooltip-target="tooltip-new" type="button" @click="hiddenStore.showAdd = !hiddenStore.showAdd, hiddenStore.blur = !hiddenStore.blur"
            ...
            <button data-tooltip-target="tooltip-settings" type="button" @click="hiddenStore.showAdjustment = !hiddenStore.showAdjustment, hiddenStore.blur = !hiddenStore.blur"
            ...
            <button data-tooltip-target="tooltip-profile" type="button" @click="hiddenStore.showLogin = !hiddenStore.showLogin, hiddenStore.blur = !hiddenStore.blur"
                class="inline-flex flex-col items-center justify-center px-5 rounded-e-full hover:bg-gray-50 ">
                <svg class="w-5 h-5 mb-1 text-gray-500  group-hover:text-blue-600 "
                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    <path
