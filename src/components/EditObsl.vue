        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            <div class="max-h-[450px] overflow-auto relative bg-white rounded-lg shadow">
                ...
                <div v-if="userStore.userCost != 0">
                    ...
                    <label class="block mb-2 mx-5 mt-4 text-sm font-medium text-gray-900">Последняя замена тормозной жидкости</label>
                    <div class="flex">
                        <div class="relative w-full mx-5 mb-5">
                            <input type="search" v-model="tormozn" :placeholder="userStore.userTormozn"
...
const tormozn = ref()
function editTormozn() {
    if (userStore.userID === 1) {
        hiddenStore.showLogin()
    }
    else {
        axios.patch(`https://dexone.ru/backend_fuelly/data/${userStore.userID}`, { tormozn: tormozn.value }) //
