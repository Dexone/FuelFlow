<template>
    ...
    <div   id="authentication-modal" tabindex="-1" aria-hidden="true" :class="{ 'hidden': hiddenStore.showAdjustment }"
        class=" fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-w-md mx-auto">
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="max-h-[450px] overflow-auto relative bg-white rounded-lg shadow">
                ...
                <div class=" flex items-center justify-center mx-auto w-56 h-56 rounded-lg "
                ...
                <div v-if="hiddenStore.loaderUpdateInfo === false">
                    ...
                    <div class="flex">
                        <div class="relative w-full mx-5 mb-5">
                            <input type="search" id="search-dropdown" v-model="maslo" :placeholder="userStore.userMaslo"
                                class="rounded-s-lg block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg rounded-s-gray-100 rounded-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 "
                                required />
                    ...
                    <div class="flex">
                        <div class="relative w-full mx-5 mb-5">
                            <input type="search" id="search-dropdown" v-model="svechi"
                                :placeholder="userStore.userSvechi"
                                class="rounded-s-lg block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg rounded-s-gray-100 rounded-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 "
                                required />
                    ...
                    <div class="flex">
                        <div class="relative w-full mx-5 mb-5">
                            <input type="search" id="search-dropdown" v-model="masloAKPP"
                                :placeholder="userStore.userMasloAKPP"
                                class="rounded-s-lg block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg rounded-s-gray-100 rounded-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 "
                                required />
                    ...
                    <div class="flex">
                        <div class="relative w-full mx-5 mb-5">
                            <input type="search" id="search-dropdown" v-model="toplFilter"
                                :placeholder="userStore.userToplFilter"
                                class="rounded-s-lg block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg rounded-s-gray-100 rounded-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 "
                                required />
...
function editValue() {
    if (userStore.userID === 1) {
        ...
        // hiddenStore.showAdjustment = true
    }
}
