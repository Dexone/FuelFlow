<template>
    <div  :class="{ 'hidden': hiddenStore.showLogin }"
        class=" overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full inset-0 h-[calc(100%-1rem)] max-w-md max-h-[450px] mx-auto">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-4 p-5" v-if="showing == 'log' && userStore.userID == 1">
                    <a class="space-y-4">
                        ...
                        <button @click="userStore.enter(enterData)"
                ...
                <div class="p-4 p-5" v-if="showing == 'edit' && userStore.userID > 1">
                    <a class="space-y-4">
                        ...
                        <button @click="userStore.editPassword(editPassData)"
